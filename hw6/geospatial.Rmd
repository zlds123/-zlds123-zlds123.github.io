...
counties <- st_read("data/tl_2019_us_county-1/tl_2019_us_county.shp")
```
...
```{python, echo=T, eval=F, mappImage, screenshot.force = TRUE}
import pandas as pd
import fiona
...
counties = fiona.open("data/tl_2019_us_county-1/tl_2019_us_county.shp")
...
![](C:\\Users\Perry\Downloads\choro.png)
